This repository provides code snippets for extracting convolutional layer parameters from darknet's weight files as well as an example of how to load this parameters.
